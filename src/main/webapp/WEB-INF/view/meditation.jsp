...
<div class="w3-top">
    <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto; background-color: orange;">
        ...
        <div class="w3-center w3-padding-16">Meditation</div>
    </div>
</div>
...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
   ...
   <c:forEach var="meditation" items="${meditations}">
       <div class="image-container">
        <a href="${meditation.pageLink}"> <!-- Correct URL -->

               <img src="${meditation.imageLink}" width="550px" height="400px" alt="${meditation.meditationType}">
               <h2>${meditation.id} . ${meditation.meditationType}</h2>
